                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title"><strong>Ajouter</strong> projet</h3>
...
<div class="form-group">
                  <label class="col-md-3 col-xs-12 control-label">Numero projet</label>
...
if (isset ($_POST['submit']))
{
	...
	if (empty ($np) ||empty ($nom) || empty($dated)|| empty($datef))
  ...
  $sql= "UPDATE projet SET prj_id='$np',
                           prj_intitule='$nom',
                           prj_desc='$desc',
							prj_dated='$dated',
							prj_datef= '$datef'
   ...
   WHERE   prj_id='$np'";  
		...
		if (mysql_query($sql))
			$info = 'Le projet a été modifiee avec succès !!!';
		else
			$info = 'Erreur lors de la modification de projet !!!';
