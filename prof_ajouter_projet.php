                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title"><strong>Modifier</strong> projet</h3>
...
<div class="form-group">
                  <label class="col-md-3 col-xs-12 control-label">Nom projet</label>
                  ...
                  <label class="col-md-3 col-xs-12 control-label">DateDebut</label>
                                        <div class="col-md-6 col-xs-12">
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="DD" class="form-control datepicker">                                            
                                            </div>
                                            <span class="help-block">Click on input field to get datepicker</span>
                                        </div>
                                    </div>
<div class="form-group">                                        
                  <label class="col-md-3 col-xs-12 control-label">DateFin</label>
                                        <div class="col-md-6 col-xs-12">
                                            <div class="input-group">
                                                <span class="input-group-addon"><span class="fa fa-calendar"></span></span>
                                                <input type="text" name="DF" class="form-control datepicker">                                            
                                            </div>
                                            <span class="help-block">Click on input field to get datepicker</span>
                                        </div>
                                    </div>
...
if (isset ($_POST['submit']))
{
	...
	if (empty ($nom) || empty($desc) || empty($dated)|| empty($datef))
	...
	else
	{
		...
		$query = "insert into projet (prj_id,prj_intitule,prj_desc,prj_dated,prj_datef) values('','$nom','$desc','$dated','$datef')";
 
		if (mysql_query($query))
			$info = 'Le projet a été créé avec succès !!!';
		else
			$info = 'Erreur lors de la création de projet !!!';
